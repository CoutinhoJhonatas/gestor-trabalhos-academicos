...
import com.git.gestor_academico.security.jwt.JwtAuthenticationFilter;
import com.git.gestor_academico.security.jwt.JwtAuthorizationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(httpSecurityCsrfConfigurer -> httpSecurityCsrfConfigurer.disable())
                ...
                .headers(headers -> headers
                        .frameOptions(frameOptions -> frameOptions.disable()) //Allow frames from the same origin
                )
